...
for i in range(len(phi_range)):
    ...
    SP_Li, SP_Ui = int(ti_SP//dt), int(10.0//dt) # start at 1 sec, end at 100 sec
    SP_Li_alt, Lp_Ui_alt = int(10.0//dt), int(10.0//dt) # start at 1 sec, end at 100 sec
    

    # print('\n')
    print('\n------Short Period Estimate------\n')
    (A,a,w,T,z), fun = fit_sinusoid(time[SP_Li:SP_Ui], np.asarray(airspeed[SP_Li:SP_Ui]) - V0, plot_results=True, ylabel = 'Airspeed [ft/s]')
    SP_V_damp.append(a)
    SP_V_period.append(2*np.pi/abs(w))
