...
class MU_tables:
    ...
    def __init__(self, input_file, input_range_json, name_of_output_file):
        self.input_file = input_file
        self.input_range_json = input_range_json
        self.load_json()
        self.name_of_output_file = name_of_output_file
    ...
    def loop_and_create_tables(self, alpha_vals, beta_vals, elevator_vals, aileron_vals, rudder_vals, p_vals, q_vals, r_vals, velocity_vals):
        ...
        # Create CSV file with independent variables OPTIONAL (JUST FOR MAKING SURE IT MAKES THE TABLE THE WAY YOU WANT)
        ...
        ## Write to CSV file
        output_file_name = self.name_of_output_file
...
if __name__=="__main__":
    ...
    vals = MU_tables("F16_RC_input.json", "F16_RC_inputranges.json", "C(x,y,z,l,m,n)(alpha,beta,de,da,dr,p,q,r,v)_withVentralFins")
