...
int main (int argc, char * const argv[]) {
    ...
    inputVariables[2] = parametersJson["dh[deg]"]; // hstab deflection
    ...
    inputVariables[5] = parametersJson["da[deg]"]; // aileron deflection
    inputVariables[6] = parametersJson["dr[deg]"]; // rudder deflection
